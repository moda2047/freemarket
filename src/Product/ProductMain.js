...
function ProductMain({ props }) {
  ...
  const handleListSearch = () => {
    const ProductlistSearchAPI =
      process.env.REACT_APP_API_URL + "/product/searchList";
  ...
  return (
    <div className="productMain">
            ...
            return (
              <div className="productMain-productRow-container">
                ...
                <div className="productRow">
                  ...
                  categorizedData[category].length >= 4 ? (
                    <>
                    ...
                    <>
                      {categorizedData[category] &&
                        categorizedData[category].map((product, index) => (
      ...
      <div className="productMain-sidebar right"></div>
    </div>
  );
}
